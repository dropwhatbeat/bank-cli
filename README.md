...
Develop Native Mobile Application (Swift/Kotlin), a React SPA, or a JavaScript/TypeScript command line interface (CLI) to simulate interaction with a retail bank. Implement the following commands:
...
## Emphasis
Clean, readable code, with proper unit & integration tests cases implemented
